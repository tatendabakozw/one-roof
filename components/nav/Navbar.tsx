...
function Navbar(props: Props): ReactElement {
    ...
    return (
        <nav
        className={`${shadowOn ? 'shadow' : 'shadow-none'} + relative bg-white flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg`}>
          ...
          >
            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                ...
                >
                  <i className="fas fa-arrow-alt-circle-down"></i> Options go here
                </button>
              </li>
            </ul>
          </div>
