...
function Login():ReactElement {
    ...
    return (
        <HomeLayout page_title="Log In" page_description="Log in to on roof market platform">
            <div className="flex h-screen w-full">
                <div className="m-auto w-1/3 flex flex-col">
                    <p className="text-gray-700 text-3xl self-center font-semibold mb-8">Log In</p>
                    <span 
                        onClick={signInWithGoogleAuth}
                        className="bg-blue-700 hover:bg-blue-600 cursor-pointer rounded-lg p-2 text-white text-xl text-center mb-8">Log in with Google</span>
                    <div className="grid grid-cols-4 items-center mb-8">
                        <div className="border-b col-span-1 border-gray-400 w-full "/>
                        <p className="col-span-2 text-center">or log in with credentials</p>
                        <div className="border-b col-span-1 border-gray-400 w-full "/>
                    </div>
                    <form action="" className="flex flex-col" onSubmit={signInWithCreds}>
                        ...
                        <input 
                            ...
                            className="border-2 border-gray-300 rounded-lg p-2 outline-none mb-8" />
                        <button className="bg-blue-900 hover:bg-blue-800 rounded-lg p-2 text-white text-xl text-center outline-none border-none " type="submit">Login</button>
                    </form>
                </div>
            </div>
        </HomeLayout>
