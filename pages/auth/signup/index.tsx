        ...
        <HomeLayout page_title={'Sign Up'}>
            <div className="pt-16 flex h-screen w-full">
                <div className="m-auto w-1/3 flex flex-col">
                    ...
                    <span className="bg-blue-700 rounded-lg p-2 text-white text-xl text-center mb-8">Sign up with google</span>
                    ...
                    <form action="" className="flex flex-col" onSubmit={signInWithCreds}>
                        ...
                        <input 
                            ...
                            className="border-2 border-gray-300 rounded-lg p-2 outline-none mb-8" />
                        <button className="bg-blue-900 rounded-lg p-2 text-white text-xl text-center" type="submit">Sign Up</button>
                    </form>
                </div>
            </div>
        </HomeLayout>
